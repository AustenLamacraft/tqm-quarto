...
This representation is sometimes called __Anderson spins__. In this way we can write @eq-pair-h as a spin chain
...
then the variational energy @eq-bcs-en has the form (except for a constant)
