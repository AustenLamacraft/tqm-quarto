...
- Notice that $z^\dagger = \bar z$ while $(\partial_{\bar z})^\dagger = -\partial_z$
...
$$
have energy $\omega_c/2$ 

- Since $\braket{\psi}{A^\dagger A}{\psi}\geq 0$ these belong to the __lowest Landau level__ (LLL)
